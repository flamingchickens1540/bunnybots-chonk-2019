...
public class ControlUtils {
    ...
    public static double velocityPosNegConstrain(double velocity, double maxVelocity,
        double minVelocity) {
    ...
    public static double allVelocityConstraints(double output, double max, double min,
        double deadzone) {
     ...
     * @return y
     */
    public static double linearDeadzoneRamp(double input, boolean allowNegativeValues, double fast,
