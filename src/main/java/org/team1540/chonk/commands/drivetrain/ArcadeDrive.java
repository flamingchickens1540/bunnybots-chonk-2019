...
public class ArcadeDrive extends Command {
    ...
    protected void execute() {
        ...
        double throttleLeft  = Utilities.processDeadzone(OI.driver.getY(GenericHID.Hand.kRight), .1) + Utilities.processDeadzone(OI.driver.getX(GenericHID.Hand.kRight), .1);
